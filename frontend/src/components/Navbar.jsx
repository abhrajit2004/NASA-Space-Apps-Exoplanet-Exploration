  ...
  return (
    <>
      <nav>
        ...
        <div className={`menu ${open ? "flex right-0" : "hidden opacity-0 z-[-10]"}  absolute top-0 bg-black/40 backdrop-blur-md text-white h-screen w-1/2 transition-all duration-500 ease-in-out  flex-col items-center justify-center text-2xl sm:flex gap-14 font-semibold `}>
